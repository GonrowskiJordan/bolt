...
import { Building2, Plus, Search, Filter, AlertCircle, MapPin, Users, Phone, Mail, Calendar, BarChart3, ChevronRight, MoreHorizontal, FileText } from 'lucide-react';
...
export default function BrokerClients() {
  ...
  const pathBase = isReadOnly ? '/broker/clients-readonly' : '/broker/clients';
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <button 
                        ...
                        onClick={() => {
                          ...
                          window.location.href = isReadOnly ? '/broker/employees-readonly' : '/broker/employees';
                        }}
                      >
                      ...
                      <button 
                        ...
                        onClick={() => {
                          setSelectedClient(null);
                          window.location.href = isReadOnly ? '/broker/documents-readonly' : '/broker/documents';
                        }}
                      >
                      ...
                      <button 
                        ...
                        onClick={() => {
                          setSelectedClient(null);
                          window.location.href = isReadOnly ? '/broker/reports-readonly' : '/broker/reports';
                        }}
                      >
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="text-sm text-gray-500">
                  {isReadOnly ? 'View client organizations' : 'Manage and monitor all your client organizations'}
                </p>
              </div>
              {!isReadOnly && (
            ...
            <div className="bg-white shadow rounded-lg mb-8">
              <div className="px-4 py-5 border-b border-gray-200 sm:px-6 flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
