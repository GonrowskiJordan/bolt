...
export default function EmployerProgressSteps({ currentStep, steps }) {
  ...
  // For a 6-step process (steps.length = 6):
  // Step 0: 0%
  // Step 1: 20% (reaches step 1)
  // Step 2: 40% (reaches step 2)
  // Step 3: 60% (reaches step 3)
  // Step 4: 80% (reaches step 4)
  // Step 5: 100% (reaches step 5 - the last step)
