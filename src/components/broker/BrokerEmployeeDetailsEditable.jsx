...
import { X, Mail, Phone, Calendar, Shield, User, Briefcase, FileText, Info, Building2, Save, CheckCircle } from 'lucide-react';
import { StatusBadge } from '../../pages/broker/BrokerEmployees';

export default function BrokerEmployeeDetailsEditable({ employee, isOpen, onClose, onSave }) {
  ...
  const handleSave = () => {
    ...
    setTimeout(() => {
      ...
      // Call onSave prop with the updated data
      if (onSave) {
        onSave(formData);
      }
              ...
              <div className="flex items-center justify-between px-4 py-6 border-b border-gray-200">
                <div>
                  <h2 className="text-lg font-medium text-gray-900">
                    {employee ? `Edit Employee: ${employee.firstName} ${employee.lastName}` : 'Edit Employee'}
                  </h2>
                  {employee && (
                  ...
                  <div className="space-y-6">
                      ...
                      <div className="space-y-4 text-sm">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div>
                            ...
                            <select
                              value={formData.employmentDetails?.type || 'Full Time'}
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            ...
                            <select
                              value={formData.employmentDetails?.payType || 'Salary'}
                            ...
                            <div>
                              ...
                              <div className="relative">
                                ...
                                <input
                                  ...
                                  step="0.01"
                                  min="0"
                                  value={formData.employmentDetails?.hourlyRate || 0}
                          ...
                          {formData.employmentDetails?.payType === 'Hourly' && (
                            <div>
                              ...
                              <input
                                type="number"
                                min="0"
                                value={formData.employmentDetails?.avgHoursPerWeek || 0}
                                onChange={(e) => handleChange('employmentDetails', 'avgHoursPerWeek', parseInt(e.target.value, 10) || 0)}
                                className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm"
                              />
                            </div>
                          )}
                          <div className={formData.employmentDetails?.payType === 'Hourly' ? '' : 'col-span-2'}>
                            ...
                            <div className="relative">
                              ...
                              <input
                                type="number"
                                min="0"
                                value={formData.employmentDetails?.annualWages || 0}
                    ...
                    <div className="bg-white border border-gray-200 p-4 rounded-lg">
                      ...
                      <div className="space-y-4 text-sm">
                        ...
                        <div>
                          ...
                          <input
                            type="text"
                            value={formData.planDetails?.plan || 'No Plan Selected'}
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <div className="flex items-center mb-3">
                        ...
                        <h4 className="text-xs font-medium text-gray-500 uppercase tracking-wider">Related Documents</h4>
                      </div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <div className="flex items-center mb-3">
                        ...
                        <h4 className="text-xs font-medium text-gray-500 uppercase tracking-wider">Notes & Comments</h4>
                      </div>
