...
export default function ShopSelection({ onShopSelf, onBack }) {
        ...
        <div className="flex-1 flex flex-col min-h-screen lg:ml-[200px]">
          ...
          <div className="p-6 max-w-4xl mx-auto mt-6">
            <div className="bg-white shadow-lg rounded-lg p-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Choose How to Shop for Health Insurance</h2>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Option 1: Shop Myself */}
                <div className="border-2 border-indigo-100 rounded-xl p-6 hover:border-indigo-500 hover:shadow-md transition-all cursor-pointer" onClick={onShopSelf}>
                ...
                {/* Option 2: Get Help */}
                <div className="border-2 border-purple-100 rounded-xl p-6 hover:border-purple-500 hover:shadow-md transition-all cursor-pointer">
